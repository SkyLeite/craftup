...
var $author$project$Route$CraftingList = function (a) {
	return {$: 'CraftingList', a: a};
};
var $author$project$Route$CraftingLists = {$: 'CraftingLists'};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Route$CraftingList,
			A2(
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$CraftingLists,
			$elm$url$Url$Parser$s('lists'))
		]));
var $author$project$Main$initModel = F2(
	function (url, navKey) {
		return {
			foundItems: $elm$core$Maybe$Nothing,
			itemQuery: $elm$core$Maybe$Nothing,
			navKey: navKey,
			route: A2($elm$url$Url$Parser$parse, $author$project$Route$parser, url),
...
var $author$project$Main$init = F3(
	function (_v0, url, navKey) {
		return _Utils_Tuple2(
			A2($author$project$Main$initModel, url, navKey),
			$elm$core$Platform$Cmd$none);
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$App$GotItemsResponse = function (a) {
	return {$: 'GotItemsResponse', a: a};
};
var $author$project$DataTypes$Item$Item = function (name) {
	return {name: name};
};
...
var $author$project$Api$Object$Item$name = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'name', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$DataTypes$Item$itemSelectionSet = A2($dillonkearns$elm_graphql$Graphql$SelectionSet$map, $author$project$DataTypes$Item$Item, $author$project$Api$Object$Item$name);
...
var $author$project$Api$Query$items = F2(
	function (requiredArgs, object_) {
		return A4(
			...
			_List_fromArray(
				[
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'name', requiredArgs.name, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)
				]),
			object_,
			A2($elm$core$Basics$composeR, $elm$core$Basics$identity, $elm$json$Json$Decode$list));
	});
var $author$project$DataTypes$Item$itemSearchQuery = function (name) {
	return A2(
		$author$project$Api$Query$items,
		{name: name},
		$author$project$DataTypes$Item$itemSelectionSet);
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$Api$graphqlUrl = 'http://localhost:4000/';
...
var $author$project$Api$makeRequest = F2(
	function (query, msg) {
		return A2(
			$dillonkearns$elm_graphql$Graphql$Http$send,
			msg,
			A2($dillonkearns$elm_graphql$Graphql$Http$queryRequest, $author$project$Api$graphqlUrl, query));
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'EnteredItemQuery':
				var query = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							itemQuery: $elm$core$Maybe$Just(query)
						}),
					A2(
						$author$project$Api$makeRequest,
						$author$project$DataTypes$Item$itemSearchQuery(query),
						$author$project$App$GotItemsResponse));
				...
				if (response.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								foundItems: $elm$core$Maybe$Just(items)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
...
var $pehota$elm_zondicons$Zondicons$search = function (attributes) {
	return A2(
		$elm$svg$Svg$svg,
		A2(
			$elm$core$List$cons,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M12.9 14.32a8 8 0 1 1 1.41-1.41l5.35 5.33-1.42 1.42-5.33-5.34zM8 14A6 6 0 1 0 8 2a6 6 0 0 0 0 12z')
					]),
				_List_Nil)
			]));
};
var $author$project$Components$searchInput = function (msg) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$pehota$elm_zondicons$Zondicons$search(
				_List_fromArray(
					[
...
var $author$project$Pages$CraftingLists$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('craftingListView')
			]),
		_List_fromArray(
			[
				$author$project$Components$searchInput(
				function (s) {
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('lists')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
...
var $author$project$Main$mainArea = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				if (_v0.$ === 'Just') {
					...
					switch (route.$) {
						...
						default:
							return $author$project$Pages$CraftingLists$view(model);
					}
				} else {
					return A2($elm$html$Html$div, _List_Nil, _List_Nil);
				}
...
var $author$project$Navbar$logo = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('m-4 sm:mr-64')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$src('http://garlandtools.org/files/icons/action/1668.png')
						]),
					_List_Nil)
				]))
		]));
var $author$project$App$OpenSearchModal = {$: 'OpenSearchModal'};
...
var $author$project$Navbar$searchButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('flex-auto flex items-center space-x-3 sm:space-x-4 text-gray-600 font-medium leading-6'),
			$elm$html$Html$Events$onClick($author$project$App$OpenSearchModal)
		]),
	_List_fromArray(
		[
			$pehota$elm_zondicons$Zondicons$search(
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$class('text-gray-400 w-4')
				])),
			A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Quick search')
				]))
		]));
var $author$project$Navbar$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('sticky flex border-b-2')
			]),
		_List_fromArray(
			[$author$project$Navbar$logo, $author$project$Navbar$searchButton]));
};
var $author$project$App$CloseSearchModal = {$: 'CloseSearchModal'};
...
var $author$project$Search$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('w-screen h-screen left-0 top-0 fixed z-50 bg-black bg-opacity-25 flex items-center flex-col p-4 pb-48'),
				$elm$html$Html$Attributes$classList(
				_List_fromArray(
					[
						_Utils_Tuple2('hidden', !model.searchModalOpen)
					])),
				$elm$html$Html$Events$onClick($author$project$App$CloseSearchModal)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('w-full max-w-2xl p-4 bg-white h-4/5 rounded shadow-lg h-full'),
						A2(
						$elm$html$Html$Events$stopPropagationOn,
						'click',
						$elm$json$Json$Decode$succeed(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('hi everyone!')
							]))
					]))
			]));
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('w-full max-w-7xl mx-auto')
					]),
				_List_fromArray(
					[
						$author$project$Navbar$view(model),
						$author$project$Main$mainArea(model)
					])),
				$author$project$Search$view(model)
			]),
		title: 'XIVCraft'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		onUrlChange: $author$project$App$ChangedUrl,
		onUrlRequest: $author$project$App$ClickedLink,
